...
import { EditOutlined, EyeOutlined, MinusCircleOutlined, PlusCircleOutlined } from '@ant-design/icons';
...
export default function Staffs(props) {
    ...
    const handleOk = () => {
        Inertia.put(route('staffs.unActive', { staff: deletedUserId }), {}, {
            onSuccess: () => {
    ...
    return (
        ...
        >
            ...
            >
                <p className="font-semibold text-xl text-rose-600 leading-tight">{lang.get('strings.Inactive-User-Confirm')}</p>
            </Modal>
            <div className="py-12">
